...
CREATE UNIQUE INDEX "notes_tenant_dedupe_idx" ON "notes" USING btree ("tenant_id","dedupe_key");--> statement-breakpoint
CREATE INDEX "notes_tenant_created_idx" ON "notes" USING btree ("tenant_id","created_utc");--> statement-breakpoint
CREATE INDEX "notes_tenant_devicenum_idx" ON "notes" USING btree ("tenant_id","device_note_num");